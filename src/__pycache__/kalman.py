...
if __name__ == "__main__":
    ...
    positions = list(zip(simulation.position_x, simulation.position_y, simulation.position_z))
    x = list(zip(simulation.theta, simulation.phi, simulation.dtheta, simulation.dphi))
    print(x)
